...
/*   Updated: 2023/03/17 14:33:51 by bmaaqoul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

// CPP Program to demonstrate the implementation of map
...
// 	// printing map gquiz1 again

// 	cout << "\nThe map gquiz1 after adding extra "
// 			"elements is : \n";
// 	cout << "\tKEY\tELEMENT\n";
// 	for (itr = gquiz1.begin(); itr != gquiz1.end(); ++itr) {
// 		cout << '\t' << itr->first << '\t' << itr->second
...
// 	cout << "\nThe map gquiz2 after assign from "
// 			"gquiz1 is : \n";
// 	cout << "\tKEY\tELEMENT\n";
...
// 	// lower bound and upper bound for map gquiz1 key =
// 	// 5
